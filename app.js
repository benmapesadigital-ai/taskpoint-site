...
const tg=$('#testimonialGrid');dailyShuffle(COMMUNITY).forEach((t,i)=>{const e=document.createElement('article');e.className='testimonial';e.innerHTML=`<div class="person"><div class="avatar avatar-${i%4}" aria-hidden="true">${t[0]}</div><div><b>${t[1]}</b><span class="country">${t[2]}</span><div class="stars" aria-label="5 stars">★★★★★</div></div></div><p>“${t[3]}”</p>`;tg.appendChild(e)});
